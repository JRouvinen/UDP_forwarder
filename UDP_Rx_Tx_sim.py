...
class UDP_rx_tx_sim():
    ...
    def __init__(self):
        ...
        print("Give IP where to listen traffic")
        self.targetHost = str(input())

        print("Give port to listen:")
        ...
        self.listen(self.targetHost, self.listenPort)
    ...
    def sender(self, ip, port, data):
        ...
        self.listener(self.targetHost, self.listenPort)
    ...
    def sleeper(self):
        ...
        self.sender(self.rem1_ip, self.rem1_port, self.data)
